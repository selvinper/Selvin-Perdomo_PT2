...
Activamos los módulos de Apache necesarios para que PHP funcione correctamente.


3. Crear el directorio web

Creamos un directorio para alojar Nextcloud en (/var/www/domini.local) y nos aseguramos de que esté vacío antes de copiar los archivos.
